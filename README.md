...
CodePath AI110 coursework: repair a Streamlit number-guessing game and test its
state and hint logic. The debugging notes below document the original exercise.
